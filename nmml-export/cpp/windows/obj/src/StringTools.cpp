...
::String StringTools_obj::urlEncode( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",38)
...
::String StringTools_obj::urlDecode( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",59)
...
::String StringTools_obj::htmlEscape( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",80)
...
::String StringTools_obj::htmlUnescape( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",87)
	return s.split(HX_CSTRING("&gt;"))->join(HX_CSTRING(">")).split(HX_CSTRING("&lt;"))->join(HX_CSTRING("<")).split(HX_CSTRING("&amp;"))->join(HX_CSTRING("&"));
}
...
bool StringTools_obj::startsWith( ::String s,::String start){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",98)
...
bool StringTools_obj::endsWith( ::String s,::String end){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",106)
	int elen = end.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",107)
	int slen = s.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",108)
...
bool StringTools_obj::isSpace( ::String s,int pos){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",115)
	Dynamic c = s.charCodeAt(pos);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",116)
...
::String StringTools_obj::ltrim( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",126)
	int l = s.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",127)
	int r = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",128)
	while(((bool((r < l)) && bool(::StringTools_obj::isSpace(s,r))))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",128)
		(r)++;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",131)
	if (((r > (int)0))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",132)
		return s.substr(r,(l - r));
	}
	else{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",134)
		return s;
	}
}
...
::String StringTools_obj::rtrim( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",145)
	int l = s.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",146)
	int r = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",147)
	while(((bool((r < l)) && bool(::StringTools_obj::isSpace(s,((l - r) - (int)1)))))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",147)
		(r)++;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",150)
	if (((r > (int)0))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",150)
		return s.substr((int)0,(l - r));
	}
	else{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",152)
		return s;
	}
}
...
::String StringTools_obj::trim( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",161)
...
::String StringTools_obj::rpad( ::String s,::String c,int l){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",176)
	int sl = s.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",177)
	int cl = c.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",178)
	while(((sl < l))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",178)
		if ((((l - sl) < cl))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",180)
			hx::AddEq(s,c.substr((int)0,(l - sl)));
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",181)
			sl = l;
		}
		else{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",183)
			hx::AddEq(s,c);
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",184)
			hx::AddEq(sl,cl);
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",187)
	return s;
}
...
::String StringTools_obj::lpad( ::String s,::String c,int l){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",198)
	::String ns = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",199)
	int sl = s.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",200)
	if (((sl >= l))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",200)
		return s;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",202)
	int cl = c.length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",203)
	while(((sl < l))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",203)
		if ((((l - sl) < cl))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",205)
			hx::AddEq(ns,c.substr((int)0,(l - sl)));
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",206)
			sl = l;
		}
		else{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",208)
			hx::AddEq(ns,c);
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",209)
			hx::AddEq(sl,cl);
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",212)
	return (ns + s);
}
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",219)
...
::String StringTools_obj::hex( int n,Dynamic digits){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",236)
	::String s = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",237)
	::String hexChars = HX_CSTRING("0123456789ABCDEF");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",238)
	do{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",239)
		s = (hexChars.charAt((int(n) & int((int)15))) + s);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",240)
		hx::UShrEq(n,(int)4);
	}
while(((n > (int)0)));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",243)
	if (((digits != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",244)
		while(((s.length < digits))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",245)
			s = (HX_CSTRING("0") + s);
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",246)
	return s;
}
...
int StringTools_obj::fastCodeAt( ::String s,int index){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",253)
	return s.cca(index);
}
...
bool StringTools_obj::isEOF( int c){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/StringTools.hx",270)
	return (c == (int)0);
}

...
{
{
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",29)
...
Void Hash_obj::set( ::String key,Dynamic value){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",33)
...
Dynamic Hash_obj::get( ::String key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",37)
...
bool Hash_obj::exists( ::String key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",41)
...
bool Hash_obj::remove( ::String key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",45)
...
Dynamic Hash_obj::keys( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",53)
	Array< ::String > a = Array_obj< ::String >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",54)
	this->__Internal->__GetFields(a);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",55)
	return a->iterator();
}
...
Dynamic Hash_obj::iterator( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",62)
	Array< ::String > a = Array_obj< ::String >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",63)
	this->__Internal->__GetFields(a);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",64)
	Dynamic it = Dynamic( Array_obj<Dynamic>::__new().Add(a->iterator()));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",65)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it,Array< ::Hash > &me){
			...
			bool run(){
{
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",67)
			...
			Dynamic run(){
{
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",68)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",66)
...
::String Hash_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",77)
	::StringBuf s = ::StringBuf_obj::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",78)
	hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING("{");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",79)
	Dynamic it = this->keys();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",80)
	for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(it);  __it->hasNext(); ){
		::String i = __it->next();
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",81)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = i;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",82)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(" => ");
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",83)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = ::Std_obj::string(this->get(i));
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",84)
			if ((it->__Field(HX_CSTRING("hasNext"))())){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",85)
				hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(", ");
			}
		}
;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",87)
	hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING("}");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",88)

...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",30)
...
Void IntHash_obj::set( int key,Dynamic value){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",34)
...
Dynamic IntHash_obj::get( int key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",38)
...
bool IntHash_obj::exists( int key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",42)
...
bool IntHash_obj::remove( int key){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",46)
...
Dynamic IntHash_obj::keys( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",51)
	Array< int > a = ::__int_hash_keys(this->h);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",52)
	return a->iterator();
}
...
Dynamic IntHash_obj::iterator( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",56)
	Dynamic a = ::__int_hash_values(this->h);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",57)
...
::String IntHash_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",61)
	::StringBuf s = ::StringBuf_obj::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",62)
	hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING("{");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",63)
	Dynamic it = this->keys();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",64)
	for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(it);  __it->hasNext(); ){
		int i = __it->next();
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",65)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = i;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",66)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(" => ");
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",67)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = ::Std_obj::string(this->get(i));
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",68)
			if ((it->__Field(HX_CSTRING("hasNext"))())){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",69)
				hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(", ");
			}
		}
;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",71)
	hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING("}");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/_std/IntHash.hx",72)

...
::String Loader_obj::findHaxeLib( ::String inLib){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",36)
	try{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",38)
		::cpp::io::Process proc = ::cpp::io::Process_obj::__new(HX_CSTRING("haxelib"),Array_obj< ::String >::__new().Add(HX_CSTRING("path")).Add(inLib));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",39)
		if (((proc != null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",41)
			::haxe::io::Input stream = proc->_stdout;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",42)
			try{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",43)
				while((true)){
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",46)
					::String s = stream->readLine();
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",47)
					if (((s.substr((int)0,(int)1) != HX_CSTRING("-")))){
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",49)
						stream->close();
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",50)
						proc->close();
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",51)
						::nme::Loader_obj::loaderTrace((HX_CSTRING("Found haxelib ") + s));
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",52)
						return s;
					}
				}
			}
			...
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",57)
			stream->close();
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",58)
			proc->close();
		}
	}
	catch(Dynamic __e){
...
Dynamic Loader_obj::load( ::String func,int args){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",104)
	::nme::Loader_obj::loaderTrace((HX_CSTRING("Result : ") + result));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",110)
	return result;
}
...
Dynamic Loader_obj::tryLoad( ::String inName,::String func,int args){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",158)
	try{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",160)
		Dynamic result = ::cpp::Lib_obj::load(inName,func,args);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",161)
		if (((result != null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",163)
			::nme::Loader_obj::loaderTrace((HX_CSTRING("Got result ") + inName));
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",164)
			::nme::Loader_obj::moduleName = inName;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/Loader.hx",165)
			return result;
		}
	}
	catch(Dynamic __e){

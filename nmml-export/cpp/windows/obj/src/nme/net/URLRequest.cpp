...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",29)
	if (((inURL != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",30)
		this->url = inURL;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",31)
	this->verbose = false;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",32)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",33)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",34)
	this->authType = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",35)
	this->contentType = HX_CSTRING("application/x-www-form-urlencoded");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",36)
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",42)
		this->authType = (int)1;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",43)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",49)
		this->authType = (int)2;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",50)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
...
Void URLRequest_obj::nmePrepare( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",54)
		if (((this->data == null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",56)
			this->nmeBytes = null();
		}
		else{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",58)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::utils::ByteArray >()))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",60)
				this->nmeBytes = this->data;
			}
			else{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",61)
				if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::net::URLVariables >()))){
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",63)
					::nme::net::URLVariables vars = this->data;
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",64)
					::String str = vars->toString();
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",65)
					this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",66)
					this->nmeBytes->writeUTFBytes(str);
				}
				else{
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",68)
					if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",70)
						::String str = this->data;
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",71)
						this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",72)
						this->nmeBytes->writeUTFBytes(str);
					}
					else{
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLRequest.hx",75)

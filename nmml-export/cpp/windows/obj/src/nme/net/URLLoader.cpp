...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",56)
	super::__construct(null());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",57)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",58)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",59)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",60)
	this->state = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",61)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",62)
	if (((request != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",63)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",74)
...
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",111)
						this->onError(e);
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",112)
						return null();
					}
				}
			}
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",115)
			this->nmeDataComplete();
		}
		else{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",119)
			request->nmePrepare();
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",120)
			this->nmeHandle = ::nme::net::URLLoader_obj::nme_curl_create(request);
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",121)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",122)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",126)
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",177)
...
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
					...
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",219)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",220)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",223)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",225)
					...
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",226)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",227)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",80)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",86)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",151)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			...
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",168)
					loader->update();
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",169)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLLoader.hx",170)

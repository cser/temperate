...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",6)
	if (((inEncoded != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",8)
...
Void URLVariables_obj::decode( ::String inVars){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",13)
		Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",14)
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",14)
			int _g = (int)0;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",14)
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",17)
		{
			...
			while(((_g < fields1->length))){
				...
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",17)
				++(_g);
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",19)
				int eq = f.indexOf(HX_CSTRING("="),null());
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",20)
				if (((eq > (int)0))){
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",21)
					...
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",23)
					if (((eq != (int)0))){
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",24)
						if (((hx::ObjectPtr<OBJ_>(this) != null()))){
							HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",24)
...
::String URLVariables_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",30)
	Array< ::String > result = Array_obj< ::String >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",31)
	Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",32)
	{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",32)
		int _g = (int)0;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/net/URLVariables.hx",32)

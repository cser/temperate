...
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",21)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",23)
	this->keyCode = keyCodeValue;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",24)
	this->keyLocation = (  (((keyLocationValue == null()))) ? int((int)0) : int(keyLocationValue) );
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",25)
	this->charCode = (  (((charCodeValue == null()))) ? int((int)0) : int(charCodeValue) );
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",27)
	this->shiftKey = (  (((shiftKeyValue == null()))) ? bool(false) : bool(shiftKeyValue) );
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",28)
	this->altKey = (  (((altKeyValue == null()))) ? bool(false) : bool(altKeyValue) );
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",29)
	this->ctrlKey = (  (((ctrlKeyValue == null()))) ? bool(false) : bool(ctrlKeyValue) );
}
;
	return null();
}
...
::nme::events::Event KeyboardEvent_obj::clone( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",34)
	return ::nme::events::KeyboardEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,null(),null());
}
...
::String KeyboardEvent_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/events/KeyboardEvent.hx",40)

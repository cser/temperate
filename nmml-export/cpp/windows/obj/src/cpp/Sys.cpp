...
Array< ::String > Sys_obj::args( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",5)
	return ::__get_args();
}
...
::String Sys_obj::getEnv( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",10)
	::String v = ::cpp::Sys_obj::get_env(s);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",11)
	if (((v == null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",12)
		return null();
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",13)
	return v;
}
...
Void Sys_obj::putEnv( ::String s,::String v){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",16)
...
Void Sys_obj::sleep( double seconds){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",20)
...
bool Sys_obj::setTimeLocale( ::String loc){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",24)
...
::String Sys_obj::getCwd( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",28)
...
Void Sys_obj::setCwd( ::String s){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",32)
...
::String Sys_obj::systemName( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",36)
...
::String Sys_obj::escapeArgument( ::String arg){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",41)
	bool ok = true;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",42)
	{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",42)
		int _g1 = (int)0;
		int _g = arg.length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",42)
			int i = (_g1)++;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",43)
			switch( (int)(arg.charCodeAt(i))){
				case (int)32: case (int)34: {
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",44)
					ok = false;
				}
				;break;
				case (int)0: case (int)13: case (int)10: {
					HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",46)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",49)
	if ((ok)){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",50)
		return arg;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",51)
...
int Sys_obj::command( ::String cmd,Array< ::String > args){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",55)
	if (((args != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",56)
		cmd = ::cpp::Sys_obj::escapeArgument(cmd);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",57)
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",57)
			int _g = (int)0;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",57)
			while(((_g < args->length))){
				...
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",57)
				++(_g);
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",58)
				hx::AddEq(cmd,(HX_CSTRING(" ") + ::cpp::Sys_obj::escapeArgument(a)));
			}
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",60)
...
Void Sys_obj::exit( int code){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",63)
...
double Sys_obj::time( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",67)
...
double Sys_obj::cpuTime( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",71)
...
::String Sys_obj::executablePath( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",75)
...
::Hash Sys_obj::environment( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",80)
	Array< ::String > vars = ::cpp::Sys_obj::sys_env();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",81)
	::Hash result = ::Hash_obj::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",82)
	int i = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",83)
	while(((i < vars->length))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",84)
		result->set(vars->__get(i),vars->__get((i + (int)1)));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",85)
		hx::AddEq(i,(int)2);
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",87)
	::haxe::Log_obj::trace(result,hx::SourceInfo(HX_CSTRING("Sys.hx"),87,HX_CSTRING("cpp.Sys"),HX_CSTRING("environment")));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/Sys.hx",88)
	return result;
}

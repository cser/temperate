...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",35)
	this->__f = f;
}
;
	return null();
...
int FileInput_obj::readByte( ){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",40)
			try{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",40)
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",42)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",39)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",51)
			try{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",51)
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",53)
						return (  ((e->__IsArray())) ? int(hx::Throw (::haxe::io::Eof_obj::__new())) : int(hx::Throw (::haxe::io::Error_obj::Custom(e))) );
					}
				}
			}
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",50)
...
Void FileInput_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",62)
		this->super::close();
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",63)
...
Void FileInput_obj::seek( int p,::cpp::io::FileSeek pos){
{
		...
		struct _Function_1_1{
			inline static int Block( ::cpp::io::FileSeek &pos){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",67)
				{
::cpp::io::FileSeek _switch_1 = (pos);
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",66)
...
int FileInput_obj::tell( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",70)
...
bool FileInput_obj::eof( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/FileInput.hx",75)

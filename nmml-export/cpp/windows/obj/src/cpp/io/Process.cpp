...
{
{
	struct _Function_1_1{
		inline static Dynamic Block( ::String &cmd,Array< ::String > &args){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",102)
			try{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",102)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",103)
	this->_stdin = ::cpp::io::_Process::Stdin_obj::__new(this->p);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",104)
	this->_stdout = ::cpp::io::_Process::Stdout_obj::__new(this->p,true);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",105)
...
int Process_obj::getPid( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",108)
...
int Process_obj::exitCode( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",112)
...
Void Process_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",116)

...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",33)
	this->p = p;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",34)
...
Void Stdin_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",38)
		this->super::close();
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",39)
...
Void Stdin_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",43)
		this->buf->b[(int)0] = c;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",44)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",47)
	try{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",48)
		return ::cpp::io::_Process::Stdin_obj::_stdin_write(this->p,buf->b,pos,len);
	}
	catch(Dynamic __e){
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",50)

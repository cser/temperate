...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",67)
	this->p = p;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",68)
	this->out = out;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",69)
...
int Stdout_obj::readByte( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",73)
	if (((this->readBytes(this->buf,(int)0,(int)1) == (int)0))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",74)
		hx::Throw (::haxe::io::Error_obj::Blocked_dyn());
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",75)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",79)
	int result;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",80)
	try{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",80)
		...
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",82)
				hx::Throw (::haxe::io::Eof_obj::__new());
			}
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",85)
	if (((result == (int)0))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",85)
		hx::Throw (::haxe::io::Eof_obj::__new());
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/Process.hx",86)
	return result;
}

...
::String File_obj::getContent( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",41)
	::haxe::io::Bytes b = ::cpp::io::File_obj::getBytes(path);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",42)
	return b->toString();
}
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",46)
	Array< unsigned char > data = ::cpp::io::File_obj::file_contents(path);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",47)
...
::cpp::io::FileInput File_obj::read( ::String path,bool binary){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",50)
...
::cpp::io::FileOutput File_obj::write( ::String path,bool binary){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",54)
...
::cpp::io::FileOutput File_obj::append( ::String path,bool binary){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",58)
...
Void File_obj::copy( ::String src,::String dst){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",63)
		::cpp::io::FileInput s = ::cpp::io::File_obj::read(src,true);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",64)
		::cpp::io::FileOutput d = ::cpp::io::File_obj::write(dst,true);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",65)
		d->writeInput(s,null());
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",66)
		s->close();
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",67)
		d->close();
	}
return null();
}
...
::cpp::io::FileInput File_obj::_stdin( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",70)
...
::cpp::io::FileOutput File_obj::_stdout( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",74)
...
::cpp::io::FileOutput File_obj::_stderr( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",78)
...
int File_obj::getChar( bool echo){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/io/File.hx",82)

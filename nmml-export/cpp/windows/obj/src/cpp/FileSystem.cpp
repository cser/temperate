...
bool FileSystem_obj::exists( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",49)
...
Void FileSystem_obj::rename( ::String path,::String newpath){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",53)
		if (((::cpp::FileSystem_obj::sys_rename(path,newpath) == null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",55)
...
Dynamic FileSystem_obj::stat( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",59)
	Dynamic s = ::cpp::FileSystem_obj::sys_stat(path);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",60)
	if (((s == null()))){
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",61)
		return _Function_2_1::Block();
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",62)
	s->__FieldRef(HX_CSTRING("atime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("atime"))));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",63)
	s->__FieldRef(HX_CSTRING("mtime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("mtime"))));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",64)
	s->__FieldRef(HX_CSTRING("ctime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("ctime"))));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",65)
	return s;
}
...
::String FileSystem_obj::fullPath( ::String relpath){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",68)
...
::cpp::FileKind FileSystem_obj::kind( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",73)
	::String k = ::cpp::FileSystem_obj::sys_file_type(path);
	struct _Function_1_1{
		inline static ::cpp::FileKind Block( ::String &k){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",74)
			::String _switch_1 = (k);
			if (  ( _switch_1==HX_CSTRING("file"))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",75)
				return ::cpp::FileKind_obj::kfile_dyn();
			}
			else if (  ( _switch_1==HX_CSTRING("dir"))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",76)
				return ::cpp::FileKind_obj::kdir_dyn();
			}
			else  {
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",77)
...
bool FileSystem_obj::isDirectory( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",81)
...
Void FileSystem_obj::createDirectory( ::String path){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",85)
		if (((::cpp::FileSystem_obj::sys_create_dir(path,(int)493) == null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",87)
...
Void FileSystem_obj::deleteFile( ::String path){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",90)
		if (((::cpp::FileSystem_obj::file_delete(path) == null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",92)
...
Void FileSystem_obj::deleteDirectory( ::String path){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",95)
		if (((::cpp::FileSystem_obj::sys_remove_dir(path) == null()))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",97)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/FileSystem.hx",100)

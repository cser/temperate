...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",30)
...
Dynamic Uncompress_obj::this_run( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",34)
...
Void Uncompress_obj::setFlushMode( ::cpp::zip::Flush f){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",38)
...
Void Uncompress_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",42)
...
::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src,Dynamic bufsize){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",47)
	::cpp::zip::Uncompress u = ::cpp::zip::Uncompress_obj::__new(null());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",48)
	if (((bufsize == null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",48)
		bufsize = (int)65536;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",49)
	::haxe::io::Bytes tmp = ::haxe::io::Bytes_obj::alloc(bufsize);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",50)
	::haxe::io::BytesBuffer b = ::haxe::io::BytesBuffer_obj::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",51)
	int pos = (int)0;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",52)
	u->setFlushMode(::cpp::zip::Flush_obj::SYNC_dyn());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",53)
	while((true)){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",54)
		Dynamic r = u->this_run(src,pos,tmp,(int)0);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",55)
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",55)
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",56)
		hx::AddEq(pos,r->__Field(HX_CSTRING("read")));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",57)
		if ((r->__Field(HX_CSTRING("done")))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",58)
			break;
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",60)
	u->close();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Uncompress.hx",61)
	return b->getBytes();
}

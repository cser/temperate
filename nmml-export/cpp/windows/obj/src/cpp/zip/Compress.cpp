...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",31)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",35)
...
Void Compress_obj::setFlushMode( ::cpp::zip::Flush f){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",39)
...
Void Compress_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",43)
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",48)
	::cpp::zip::Compress c = ::cpp::zip::Compress_obj::__new(level);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",49)
	c->setFlushMode(::cpp::zip::Flush_obj::FINISH_dyn());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",50)
	::haxe::io::Bytes out = ::haxe::io::Bytes_obj::alloc(::cpp::zip::Compress_obj::_deflate_bound(c->s,s->length));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",51)
	Dynamic r = c->execute(s,(int)0,out,(int)0);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",52)
	c->close();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",53)
	if (((bool(!(r->__Field(HX_CSTRING("done")))) || bool((r->__Field(HX_CSTRING("read")) != s->length))))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",54)
		hx::Throw (HX_CSTRING("Compression failed"));
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/cpp/zip/Compress.hx",55)

...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/IntIter.hx",39)
	this->min = min;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/IntIter.hx",40)
	this->max = max;
}
;
	return null();
...
bool IntIter_obj::hasNext( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/IntIter.hx",46)
...
int IntIter_obj::next( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/IntIter.hx",53)
	return (this->min)++;
}

...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",33)
	this->length = length;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",34)
	this->b = b;
}
;
	return null();
...
int Bytes_obj::get( int pos){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",37)
...
Void Bytes_obj::set( int pos,int v){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",51)
		this->b[pos] = v;
	}
return null();
}
...
Void Bytes_obj::blit( int pos,::haxe::io::Bytes src,int srcpos,int len){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",67)
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",78)
		Array< unsigned char > b1 = this->b;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",79)
		Array< unsigned char > b2 = src->b;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",80)
		if (((bool((b1 == b2)) && bool((pos > srcpos))))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",81)
			int i = len;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",82)
			while(((i > (int)0))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",83)
				(i)--;
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",84)
				b1[(i + pos)] = b2->__get((i + srcpos));
			}
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",86)
			return null();
		}
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",88)
		{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",88)
			int _g = (int)0;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",88)
			while(((_g < len))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",88)
				int i = (_g)++;
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",89)
				b1[(i + pos)] = b2->__get((i + srcpos));
			}
		}
	}
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",95)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > this->length))))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",95)
		hx::Throw (::haxe::io::Error_obj::OutsideBounds_dyn());
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",108)
...
int Bytes_obj::compare( ::haxe::io::Bytes other){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",134)
	Array< unsigned char > b1 = this->b;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",135)
	Array< unsigned char > b2 = other->b;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",136)
	int len = (  (((this->length < other->length))) ? int(this->length) : int(other->length) );
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",137)
	{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",137)
		int _g = (int)0;
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",137)
		while(((_g < len))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",137)
			int i = (_g)++;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",138)
			if (((b1->__get(i) != b2->__get(i)))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",140)
				return (b1->__get(i) - b2->__get(i));
			}
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",144)
...
::String Bytes_obj::readString( int pos,int len){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",150)
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > this->length))))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",150)
		hx::Throw (::haxe::io::Error_obj::OutsideBounds_dyn());
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",162)
	::String result = HX_CSTRING("");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",163)
	::__hxcpp_string_of_bytes(this->b,result,pos,len);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",164)
	return result;
}
...
::String Bytes_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",192)
...
::String Bytes_obj::toHex( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",208)
	::StringBuf s = ::StringBuf_obj::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",209)
	Array< Dynamic > chars = Array_obj< Dynamic >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",210)
	::String str = HX_CSTRING("0123456789abcdef");
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",211)
	{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",211)
		int _g1 = (int)0;
		int _g = str.length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",211)
			int i = (_g1)++;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",212)
			chars->push(str.charCodeAt(i));
		}
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",213)
	{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",213)
		int _g1 = (int)0;
		int _g = this->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",213)
			int i = (_g1)++;
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",214)
			int c = this->b->__get(i);
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",215)
			{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",215)
			...
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",216)
			{
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",216)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",218)
...
Array< unsigned char > Bytes_obj::getData( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",221)
	return this->b;
}
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",242)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",243)
	if (((length > (int)0))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",243)
		a[(length - (int)1)] = (int)0;
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",244)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",264)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",265)
	::__hxcpp_bytes_of_string(a,s);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",266)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",292)

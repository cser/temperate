...
Void ApplicationMain_obj::main( ){
{
		...
		HX_SOURCE_POS("nmml-export/cpp/windows/haxe/ApplicationMain.hx",14)
		::nme::Lib_obj::setPackage(HX_CSTRING("NME"),HX_CSTRING("MyApplication"),HX_CSTRING("org.example.myproject"),HX_CSTRING("1.0.0"));

		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
		Void run(){
{
				HX_SOURCE_POS("nmml-export/cpp/windows/haxe/ApplicationMain.hx",39)
				{
				}
				HX_SOURCE_POS("nmml-export/cpp/windows/haxe/ApplicationMain.hx",45)
				::CppTestMainNmml_obj::main();
			}
			return null();
		}
		HX_END_LOCAL_FUNC0((void))

		HX_SOURCE_POS("nmml-export/cpp/windows/haxe/ApplicationMain.hx",37)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)30,(int)16777215,(int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("temperate test"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_SOURCE_POS("nmml-export/cpp/windows/haxe/ApplicationMain.hx",66)
	return null();
}
